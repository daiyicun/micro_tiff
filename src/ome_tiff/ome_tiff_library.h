 ...
 * 
 * @param handle			Handle of an opened ome-tiff file.
 * 
 ...
 * 
 * @param handle			Handle of an opened ome-tiff file.
 * @param plate_info		Plate information which need to be set.
 * 
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
 * 
 ...
 * 
 * @param handle			Handle of an opened ome-tiff file.
 * @param plates_info		PlateInfo array to carry all plates information.
 * 
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
 * 
 ...
 * 
 * @param handle			Handle of an opened ome-tiff file.
 * @param plate_id			Which plate you want add well information into.
 * @param well_info			Well information need to be set.
 * 
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
 */
 ...
 * 
 * @param handle			Handle of an opened ome-tiff file.
 * @param plate_id			Which plate you want get wells information.
 * @param wells_info		WellInfo array to carry all wells information.
 * 
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
 * 
 ...
 * 
 * @param handle			Handle of an opened ome-tiff file.
 * @param plate_id			Which plate you want add scan information into.
 * @param scan_info			Scan information need to be set.
 * 
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
 */
 ...
 * 
 * @param handle			Handle of an opened ome-tiff file.
 * @param plate_id			Which plate you want get scans information.
 * @param scans_info		ScanInfo array to carry all scans information.
 * 
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
 * 
 ...
 * 
 * @param handle			Handle of an opened ome-tiff file.
 * @param plate_id			Which plate you want add channel information into.
 * @param scan_id			Which scan you want add channel information into.
 * @param channel_info		Channel information need to be set.
 * 
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
 */
 ...
 * 
 * @param handle			Handle of an opened ome-tiff file.
 * @param plate_id			Which plate you want get channels information.
 * @param scan_id			Which scan you want get channels information.
 * @param channels_info		ChannelInfo array to carry all channels information.
 * 
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
 * 
 ...
 * 
 * @param handle			Handle of an opened ome-tiff file.
 * @param plate_id			Which plate you want remove channel from.
 * @param scan_id			Which scan you want remove channel from.
 * @param channel_id		Id of channel which you want to remove.
 * 
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
 */
 ...
 * 
 * @param handle			Handle of an opened ome-tiff file.
 * @param plate_id			Which plate you want add scan region information into.
 * @param scan_id			Which scan you want add scan region information into.
 * @param well_id			Which well you want add scan region information into.
 * @param scan_region_info	Scan region information need to be set.
 * 
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
 */
 ...
 * 
 * @param handle			Handle of an opened ome-tiff file.
 * @param plate_id			Which plate you want get scan regions information.
 * @param scan_id			Which scan you want get scan regions information.
 * @param well_id			Which well you want get scan regions information.
 * @param scan_regions_info ScanRegionInfo array to carry all scan regions information.
 * 
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
 * 
...
/**
 * @brief		Load the raw data from OME-TIFF file.
 *
 * @param[in]	handle				Handle of an opened ome-tiff file.
 * @param[in]	frame				The information of current image.
...
/**
 * @brief		Get data of custom defined tag of a single frame saved in tiff file.
 *
 * @param[in]	handle				Handle of an opened ome-tiff file.
 * @param[in]	frame				The message of current image.
 * @param[in]	tag_id				Custom tag id, which you want to store value with(tag_id between(CustomTag_First, CustomTag_Last)).
 * @param[in]	tag_size			How many memory space you have allocated for the "tag_value"(size in byte).
 * @param[out]	tag_value			Buffer of tag value stored with tag_id.
 *
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
*/
OME_TIFF_LIBRARY_API int32_t ome_get_custom_tag(int32_t handle, ome::FrameInfo frame, uint16_t tag_id, uint32_t tag_size, void* tag_value);

/**
 * @brief		Get minimum and maximum value of raw data of a single frame saved in tiff file.
 *
 * @param[in]	handle				Handle of an opened ome-tiff file.
 * @param[in]	frame				The message of current image.
 * @param[in]	tag_id				Custom tag id, which you want to get its value(tag_id between(CustomTag_First, CustomTag_Last) defined in "ome_struct.h").
 * @param[in]	tag_type			Element type of "tag_value".
 * @param[in]	tag_count			Element count of "tag_value".
 * @param[in]	tag_value			Buffer of tag value need to be stored with tag_id.
 *
 * @return		Error code defines by "ErrorCode" in "ome.def.h".
*/
OME_TIFF_LIBRARY_API int32_t ome_set_custom_tag(int32_t handle, ome::FrameInfo frame, uint16_t tag_id, 
	ome::TiffTagDataType tag_type, uint32_t tag_count, void* tag_value);
